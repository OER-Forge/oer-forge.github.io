# ========================================================================
# make2.py - Markdown to Accessible HTML Build Script for OERForge
# ========================================================================
#
# This script converts Markdown files in build/files to accessible standalone
# HTML pages in build/. It supports code highlighting, MathJax, ARIA attributes,
# and navigation menus. It also mirrors directory structure and logs events.
#
# Features:
...
def get_canonical_image_path(filename):
    """Query canonical image path from build_images DB."""
...
def convert_markdown_to_html(md_path, html_path):
    ...
    # Inject MathJax for math rendering
...
# ========================================================================
# WCAG Reports Conversion and Copy Functions
# ========================================================================
